...
The `GATEWAY_IP` environment variable will be used in the [benchmark template](../benchmark/wide_ep_random_inference_perf.yaml).

2. Follow the [benchmark guide](../../guides/benchmark/README.md) to deploy the benchmark tool and analyze the benchmark results.
