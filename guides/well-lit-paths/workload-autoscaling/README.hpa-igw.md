...
Follow the [Intelligent Inference Scheduling](https://github.com/llm-d/llm-d/blob/main/guides/well-lit-paths/inference-scheduling/README.md) well-lit path to set up an LLM deployment. By default, llm-d deployments include the necessary ServiceMonitors to scrape EPP metrics.
