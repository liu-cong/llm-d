...
## Set your namespace, PVC, and project root directory
  ...
  export BENCH_TEMPLATE_DIR="${LLMD_ROOT_DIR}"/guides/supporting/benchmark
  ```

## Set your stack type and gateway name

`GATEWAY_SVC` is your gateway service name.
`BENCHMARK_TEMPLATE` is a corresponding benchmark template file (available in [guides/supporting/benchmark](./)).
