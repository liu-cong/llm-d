...
| --- | --- | --- | --- |
| AMD | ROCm | Kenny Roche (<Kenny.Roche@amd.com>), Vincent Cave (<Vincent.Cave@amd.com>) | [Inference Scheduling](../../guides/well-lit-paths/inference-scheduling/README.md), [Prefill/Decode Disaggregation](../../guides/well-lit-paths/pd-disaggregation/README.amd.md) |
| CPU | x86_64 | Hongming Zheng (@ZhengHongming888, <hongming.zheng@intel.com>) | [Inference Scheduling](../../guides/well-lit-paths/inference-scheduling/README.md) |
| Google | [TPU](../infra-providers/gke/README.md#llm-d-on-google-kubernetes-engine-gke) | Edwin Hernandez (@Edwinhr716), Cong Liu (@liu-cong, <congliu.thu@gmail.com>) | [Inference Scheduling](../../guides/well-lit-paths/inference-scheduling/README.md), [Prefill/Decode Disaggregation](../../guides/well-lit-paths/pd-disaggregation/README.md) |
| Intel | XPU | Yuan Wu (@yuanwu2017, <yuan.wu@intel.com>) | [Inference Scheduling](../../guides/well-lit-paths/inference-scheduling/README.md), [Prefill/Decode Disaggregation](../../guides/well-lit-paths/pd-disaggregation/README.md) |
| Intel | HPU | Sakari Poussa (@poussa, <sakari.poussa@intel.com>) | [Inference Scheduling](../../guides/well-lit-paths/inference-scheduling/README.md) |
